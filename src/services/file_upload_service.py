...
class FileUploadService:
    ...
    async def upload_file(self, file: UploadFile, user_id: int, post_id: Optional[int] = None) -> Media:
        ...
        ipfs_hash = f"ipfs_{file_hash[:12]}"
        ipfs_url = f"http://localhost:8080/ipfs/{ipfs_hash}"
